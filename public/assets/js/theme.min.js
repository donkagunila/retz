...
var demoMode = (function () {
    var e,
        ...
        n,
        s,
        c = document.querySelector("#popoverDemo"),
    ...
    return (
        ...
        "light" == (e = C.colorScheme) ? ((S.disabled = !1), (y.disabled = !0), (e = "light")) : "dark" == e && ((S.disabled = !0), (y.disabled = !1), (e = "light")),
        (function (e) {
            if (d && u && f && h && p && v)
                if ("topnav" == e) {
                    L(u), L(f), L(h);
        ...
        f &&
            ...
            d &&
            ("default" == t
                ? (f.classList.add("navbar-light"), h.classList.add("navbar-light"), d.classList.add("navbar-light"))
                : "inverted" == t
                ? (f.classList.add("navbar-dark"), h.classList.add("navbar-dark"), d.classList.add("navbar-dark"))
                : "vibrant" == t && (f.classList.add("navbar-dark", "navbar-vibrant"), h.classList.add("navbar-dark", "navbar-vibrant"), d.classList.add("navbar-dark", "navbar-vibrant"))),
        ...
        i &&
            (i.addEventListener("submit", function (e) {
                var t, a, o, l, r;
                e.preventDefault(),
                    (a = (t = i).querySelector('[name="colorScheme"]:checked').value),
...
!(function () {
            ...
            return (
                1 <
                    t.datasets.filter(function (e) {
                        return !e.hidden;
                    }).length && (a = '<span class="popover-body-label mr-auto">' + r + "</span>"),
    ...
    (function () {
        ...
        function a() {
            (Chart.defaults.global.defaultColor = e[700]),
                ...
                Chart.scaleService.updateScaleDefaults("linear", {
                    gridLines: { borderDash: [2], borderDashOffset: [2], color: e[900], drawBorder: !1, drawTicks: !1, zeroLineColor: e[900], zeroLineBorderDash: [2], zeroLineBorderDashOffset: [2] },
                    ticks: {
                        beginAtZero: !0,
                        padding: 10,
                        callback: function (e) {
    ...
    (function () {
        ...
        "undefined" != typeof List &&
            e &&
            [].forEach.call(e, function (e) {
                var t, a, o, l, r, n, s, c, i, d, u;
                (a = (t = e).querySelector(".list-alert")),
                    (o = t.querySelector(".list-alert-count")),
                    (l = t.querySelector(".list-alert .close")),
                    (r = t.querySelectorAll(".list-checkbox")),
                    (n = t.querySelector(".list-checkbox-all")),
                    (s = t.querySelector(".list-pagination-prev")),
                    (c = t.querySelector(".list-pagination-next")),
                    (i = t.dataset.list && JSON.parse(t.dataset.list)),
                    (d = Object.assign({ listClass: "list", searchClass: "list-search", sortClass: "list-sort" }, i)),
                    (u = new List(t, d)),
                    c &&
